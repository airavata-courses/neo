pipeline{
    ...
    environment {
        REGISTRY = 'neoairavataproject/user-register-service'
        REGISTRY_CREDENTIAL = 'docker-credentials'
        FILE = 'user-register-service.yaml'
        SERVICE_NAME = 'user-register-service'
        DEPLOY_NAME = 'user-register-deploy'
        HOME_DIRECTORY = 'user-register-service'
